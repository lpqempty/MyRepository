...
название ТС, тип двигателя и номер двигателя. Создать вектор от класса ТС, отсортировать в алфавитном порядке и 
вывести его содержимое на экран, все ТС с названием "Man" переписать в новый вектор*/
#include "iostream"
#include "string"
#include "vector"
#include "algorithm"
